...
function alpha_entry_footer() {
	...
	if ( ! is_single() && ! post_password_required() && ( comments_open() || get_comments_number() ) ) {
		...
		comments_popup_link( esc_html__( 'Leave a comment', 'alpha' ), esc_html__( '1 Comment', 'alpha' ), esc_html__( '% Comments', 'alpha' ) );
		echo '</span>';
	}
